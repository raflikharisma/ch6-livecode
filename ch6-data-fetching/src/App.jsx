  ...
  return (
    <>
      <Modal open={errorUpdatingUserPlaces} onClose={handleError}>
        {errorUpdatingUserPlaces && <Error title="Ada error pas update user places" message={errorUpdatingUserPlaces.message} onConfirm={handleError} />}
      </Modal>
      ...
      <main>
        <Places title="I'd like to visit ..." fallbackText="Select the places you would like to visit below." places={userPlaces} onSelectPlace={handleStartRemovePlace} />
